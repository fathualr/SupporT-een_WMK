                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <label class="form-control w-full max-w-full">
                            ...
                            <input type="text" name="nama" value="{{ $user->nama }}" class="input input-bordered w-full max-w-full" />
                            @error('nama')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </label>
                    ...
                    <div>
                        <label class="form-control w-full max-w-full">
                            ...
                            <input type="email" value="{{ $user->email }}"  class="input input-bordered w-full max-w-full cursor-not-allowed" readonly/>
                            @error('email')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </label>
                    ...
                    <div>
                        <label class="form-control w-full max-w-full">
                            ...
                            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $user->tanggal_lahir->format('Y-m-d')) }}" class="input input-bordered w-full max-w-full" />
                            @error('tanggal_lahir')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </label>
                    ...
                    <div class="col-span-1 lg:col-span-2">
                        <label class="form-control">
                            ...
                            <textarea class="textarea textarea-bordered h-24" name="deskripsi_diri" placeholder="Deskripsi Diri">{{ old('deskripsi_diri', $user->pasien->deskripsi_diri ?? '') }}</textarea>
