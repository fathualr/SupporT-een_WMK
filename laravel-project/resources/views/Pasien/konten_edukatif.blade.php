                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex justify-between items-center mt-auto text-xs xl:text-sm">
                            <div class="flex items-center max-w-full">
                                <!-- profile -->
                                <img class="size-5 rounded-full" src="{{ asset('storage/' . $item->user->foto_profil) }}" alt="Album" />
                ...
                <div class="bg-color-8 p-8 border-[1px] border-color-4 rounded-2xl">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <img class="size-12 rounded-full mr-4" src="{{ asset('storage/' . $selectedKonten->user->foto_profil) }}" alt="Album" />
