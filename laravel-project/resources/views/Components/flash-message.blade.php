...
<div class="absolute top-[100px] left-1/2 transform -translate-x-1/2 -translate-y-1 z-40">
    <div role="alert" id="toast" class="alert alert-success flex items-start mb-5">
        ...
        <!-- text message -->
        <div class="text-start text-xs sm:text-base">
...
<div class="absolute top-[100px] left-1/2 transform -translate-x-1/2 -translate-y-1 z-40">
    <div role="alert" id="toast" class="alert alert-error flex items-start mb-5 ">
