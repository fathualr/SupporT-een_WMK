    ...
    <div class="pt-10 p-10">
        <form action="">
            ...
            <label class="form-control w-full pt-5 ">
                    ...
                    <input type="text" placeholder="Masukkan password Anda" class="input input-bordered input-md w-full outline outline-1 outline-color-5 bg-color-6 rounded-lg" />
            </label>
            ...
            <label class="form-control w-full pt-5 pb-10 ">
                    ...
                    <input type="number" placeholder="Masukkan password Anda" class="input input-bordered input-md w-full outline outline-1 outline-color-5 bg-color-6 rounded-lg" />
            </label>
