...
<div class="flex flex-col mx-auto w-full h-full pt-9 px-[50px] gap-6">
    ...
    <div class="flex flex-col w-full h-full gap-4">
        ...
        <div class="flex items-center border-[1px] border-color-4 rounded-2xl p-2 gap-2">
            ...
            <div class="flex-1">
                <span class="text-color-1 font-semibold">Halo kalian pernah merasakan ini gak?</span>
            </div>
        ...
        <div class="flex items-center border-[1px] border-color-4 rounded-2xl p-2 gap-2">
            ...
            <div class="flex-1">
                <span class="text-color-1 font-semibold">Apa yang secara signifikan meningkatkan kesehatan mental?</span>
            </div>
            <button class="btn btn-square btn-ghost">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-center border-[1px] border-color-4 rounded-2xl p-2 gap-2">
            <div class="flex-1">
                <span class="text-color-1 text-base font-semibold">Bagaimana menulis jurnal bisa membantu kesehatan mental menjadi lebih baik?</span>
            </div>
            <button class="btn btn-square btn-ghost">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
