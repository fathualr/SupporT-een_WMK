...
<div class="flex flex-col w-full h-full gap-4">
    ...
    <button class="btn space-y-2 h-[80px] bg-color-8 rounded-2xl outline outline-1 outline-color-4 p-3"
        onclick="document.getElementById('riwayat-aktivitas-').showModal()">
        <div class="flex flex-col justify-between text-left w-full h-full">
            <p class="text-base font-semibold text-color-1">5/8 aktivitas diselesaikan</p>
            <p class="text-xs font-medium text-color-1">Senin, 16 Oktober 2016</p>
        </div>
    </button>

    <dialog id="riwayat-aktivitas-" class="modal">
