...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('konsultasi', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_tenaga_ahli'); // Foreign key untuk merujuk pada tenaga ahli
            $table->unsignedBigInteger('id_pasien'); // Foreign key untuk merujuk pada pasien
